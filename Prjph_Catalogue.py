...
result = word.find('.') 
print ("Substring 'bla' found at index:", result ) 
  
result = word.find('blo') 
print ("Substring 'blo ' found at index:", result ) 
